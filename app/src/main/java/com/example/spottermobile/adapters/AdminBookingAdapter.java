...
public class AdminBookingAdapter extends RecyclerView.Adapter<AdminBookingAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView tvBookingId, tvMemberName, tvWorkout;
        private final TextView tvDate, tvArrival, tvStatus;
        ...
        void bind(Booking b) {
            ...
            tvDate.setText(date);
            tvArrival.setText("Arrival: " + (b.getTimeSlot() != null ? b.getTimeSlot() : "—"));

            tvCheckin.setText(b.getCheckinTime()  != null ? "In: "  + b.getCheckinTime()  : "Not checked in");
